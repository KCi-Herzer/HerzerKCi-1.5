...
#pragma region Other Initializations
	...
	//wxGridSizer* buttonSizer = new wxGridSizer(buttonSizerRows, buttonSizerCols, 0, 0);
...
#pragma region Buttons
	...
	//	{
	//		calcButtons[y * buttonSizerRows + x] = new wxButton(this, 10000 + (y * buttonSizerRows + x));
